...
var VERSION = "0.3.3";
//#endregion
//#region node_modules/groq-sdk/_shims/registry.mjs
var auto = false;
var kind = void 0;
var fetch$1 = void 0;
var FormData$1 = void 0;
var File$1 = void 0;
var ReadableStream$1 = void 0;
var getMultipartRequestOptions = void 0;
var getDefaultAgent = void 0;
var fileFromPath$1 = void 0;
var isFsReadStream = void 0;
function setShims(shims, options = { auto: false }) {
	if (auto) throw new Error(`you must \`import 'groq-sdk/shims/${shims.kind}'\` before importing anything else from groq-sdk`);
	if (kind) throw new Error(`can't \`import 'groq-sdk/shims/${shims.kind}'\` after \`import 'groq-sdk/shims/${kind}'\``);
	auto = options.auto;
	kind = shims.kind;
	fetch$1 = shims.fetch;
	shims.Request;
...
//#endregion
//#region node_modules/groq-sdk/_shims/MultipartBody.mjs
/**
...
//#endregion
//#region node_modules/groq-sdk/_shims/web-runtime.mjs
...
//#endregion
//#region node_modules/groq-sdk/_shims/index.mjs
/**
* Disclaimer: modules in _shims aren't intended to be imported by SDK users.
*/
if (!kind) setShims(getRuntime(), { auto: true });
//#endregion
//#region node_modules/groq-sdk/error.mjs
var error_exports = /* @__PURE__ */ __exportAll({
	APIConnectionError: () => APIConnectionError$1,
	APIConnectionTimeoutError: () => APIConnectionTimeoutError$1,
	APIError: () => APIError$1,
	APIUserAbortError: () => APIUserAbortError$1,
	AuthenticationError: () => AuthenticationError$1,
	BadRequestError: () => BadRequestError$1,
	ConflictError: () => ConflictError$1,
	GroqError: () => GroqError$1,
	...
	UnprocessableEntityError: () => UnprocessableEntityError$1
});
var GroqError$1 = class extends Error {};
var APIError$1 = class APIError$1 extends GroqError$1 {
	...
	static generate(status, errorResponse, message, headers) {
		if (!status) return new APIConnectionError$1({ cause: castToError(errorResponse) });
...
//#endregion
//#region node_modules/groq-sdk/lib/streaming.mjs
var Stream = class Stream {
	...
	static fromSSEResponse(response, controller) {
		...
		async function* iterMessages() {
			if (!response.body) {
				controller.abort();
				throw new GroqError$1(`Attempted to iterate over a response with no body`);
			}
			...
			try {
				for await (const sse of iterMessages()) {
					...
					if (sse.event === null) {
						...
						if (data && data.error) throw new APIError$1(void 0, data.error, void 0, void 0);
						yield data;
					}
				}
				done = true;
...
*/
var LineDecoder = class LineDecoder {
	constructor() {
		this.buffer = [];
	...
	decodeText(bytes) {
		...
		if (typeof Buffer !== "undefined") {
			...
			throw new GroqError$1(`Unexpected: received non-Uint8Array (${bytes.constructor.name}) stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.`);
		}
		if (typeof TextDecoder !== "undefined") {
			...
			throw new GroqError$1(`Unexpected: received non-Uint8Array/ArrayBuffer (${bytes.constructor.name}) in a web platform. Please report this error.`);
		}
		throw new GroqError$1(`Unexpected: neither Buffer nor TextDecoder are available as globals. Please report this error.`);
	}
	flush() {
...
//#endregion
//#region node_modules/groq-sdk/uploads.mjs
...
var multipartFormRequestOptions = async (opts) => {
	return getMultipartRequestOptions(await createForm(opts.body), opts);
};
...
var APIClient = class {
	constructor({ baseURL, maxRetries = 2, timeout = 6e4, httpAgent, fetch: overridenFetch }) {
	...
	*/
	...
	buildHeaders({ options, headers, contentLength }) {
		...
		applyHeadersMut(reqHeaders, this.defaultHeaders(options));
	...
	*/
	...
	async makeRequest(optionsInput, retriesRemaining) {
		...
		if (response instanceof Error) {
			...
			if (response.name === "AbortError") throw new APIConnectionTimeoutError$1();
	...
	stringifyQuery(query) {
		return Object.entries(query).filter(([_, value]) => typeof value !== "undefined").map(([key, value]) => {
			...
			throw new GroqError$1(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
		}).join("&");
	}
	async fetchWithTimeout(url, init, ms, controller) {
		...
		return this.getRequestClient().fetch.call(void 0, url, {
...
var startsWithSchemeRegexp = /* @__PURE__ */ new RegExp("^(?:[a-z]+:)?//", "i");
var isAbsoluteURL = (url) => {
	return startsWithSchemeRegexp.test(url);
};
var sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
var validatePositiveInteger = (name, n) => {
	if (typeof n !== "number" || !Number.isInteger(n)) throw new GroqError$1(`${name} must be an integer`);
	if (n < 0) throw new GroqError$1(`${name} must be a positive integer`);
	return n;
};
var castToError = (err) => {
...
//#endregion
//#region node_modules/groq-sdk/resource.mjs
...
//#endregion
//#region node_modules/groq-sdk/index.mjs
var _a;
...
var Groq = class extends APIClient {
	...
	*/
	constructor({ baseURL = readEnv("GROQ_BASE_URL"), apiKey = readEnv("GROQ_API_KEY"), ...opts } = {}) {
		if (apiKey === void 0) throw new GroqError$1("The GROQ_API_KEY environment variable is missing or empty; either provide it, or instantiate the Groq client with an apiKey option, like new Groq({ apiKey: 'My API Key' }).");
		const options = {
			apiKey,
			...opts,
			baseURL: baseURL || `https://api.groq.com`
		};
		if (!options.dangerouslyAllowBrowser && isRunningInBrowser()) throw new GroqError$1("This is disabled by default, as it risks exposing your secret API credentials to attackers.\nIf you understand the risks and have appropriate mitigations in place,\nyou can set the `dangerouslyAllowBrowser` option to `true`, e.g.,\n\nnew Groq({ dangerouslyAllowBrowser: true })");
		super({
...
_a = Groq;
Groq.Groq = _a;
Groq.GroqError = GroqError$1;
Groq.APIError = APIError$1;
Groq.APIConnectionError = APIConnectionError$1;
Groq.APIConnectionTimeoutError = APIConnectionTimeoutError$1;
Groq.APIUserAbortError = APIUserAbortError$1;
Groq.NotFoundError = NotFoundError$1;
Groq.ConflictError = ConflictError$1;
Groq.RateLimitError = RateLimitError$1;
Groq.BadRequestError = BadRequestError$1;
Groq.AuthenticationError = AuthenticationError$1;
Groq.InternalServerError = InternalServerError$1;
Groq.PermissionDeniedError = PermissionDeniedError$1;
Groq.UnprocessableEntityError = UnprocessableEntityError$1;
var { GroqError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, NotFoundError, ConflictError, RateLimitError, BadRequestError, AuthenticationError, InternalServerError, PermissionDeniedError, UnprocessableEntityError } = error_exports;
var toFile = toFile$1;
var fileFromPath = fileFromPath$1;
(function(Groq) {
	Groq.toFile = toFile$1;
	Groq.fileFromPath = fileFromPath$1;
	Groq.Chat = Chat;
	Groq.Audio = Audio;
	Groq.Models = Models;
})(Groq || (Groq = {}));
...
//#endregion
export { APIConnectionError, APIConnectionTimeoutError, APIError, APIUserAbortError, AuthenticationError, BadRequestError, ConflictError, Groq, GroqError, InternalServerError, NotFoundError, PermissionDeniedError, RateLimitError, UnprocessableEntityError, groq_sdk_default as default, fileFromPath, toFile };
